...
public class AlertVisualStyle: NSObject {
    ...
    public var messageFont: UIFont = UIFont.systemFontOfSize(13)
    ...
    public var defaultFont : UIFont = UIFont.systemFontOfSize(17)
    public var defaultTextColor : UIColor?
    public var defaultButtonColor : UIColor?
    
    public var preferredFont : UIFont = UIFont.boldSystemFontOfSize(17)
    public var preferredTextColor : UIColor?
    public var preferredButtonColor : UIColor?
    
    public var destructiveFont : UIFont = UIFont.systemFontOfSize(17)
